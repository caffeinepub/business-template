...
const navLinks = [
  ...
  { label: "Backgrounds", href: "#backgrounds", ocid: "nav.backgrounds.link" },
  { label: "Lists", href: "#lists", ocid: "nav.lists.link" },
  { label: "Tooltips", href: "#tooltips", ocid: "nav.tooltips.link" },
  { label: "Forms", href: "#forms", ocid: "nav.forms.link" },
